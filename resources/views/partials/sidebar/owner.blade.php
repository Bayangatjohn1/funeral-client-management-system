...
<div class="nav-section">
    <div class="nav-list">
        <a href="{{ route('owner.analytics') }}" class="{{ $isActive(request()->routeIs('owner.analytics') || request()->routeIs('reports.*')) }}">
            <svg class="{{ $iconState(request()->routeIs('owner.analytics') || request()->routeIs('reports.*')) }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
